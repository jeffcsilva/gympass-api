...
- [x] Deve ser possível o usuário realizer check-in em uma academia;
...
- [x] Os dados da aplicação precisam estar persistidos em um banco PostgraSQL;
- [x] Todas a listas de dados precisam estar paginadas com 20 items por página;
